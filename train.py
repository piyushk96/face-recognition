...
# Beginning message
print("\nThe program will save 20 samples. Move your head around to increase while it runs.\n")
...
while count < count_max:
    ...
    faces = sorted(faces, key=lambda x: x[3])           #sort based on fourth value of quad
